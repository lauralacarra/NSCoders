...
{    
    if (self = [super initWithFrame:frame])
    {
        ...
        */
        _topArrowImage = [UIImage tallImageNamed:@"popover-arrow-top.png"];
        _leftArrowImage = [UIImage tallImageNamed:@"popover-arrow-left.png"];
        _bottomArrowImage = [UIImage tallImageNamed:@"popover-arrow-bottom.png"];
        _rightArrowImage = [UIImage tallImageNamed:@"popover-arrow-top.png"];
        
        
        UIImage *popoverBackgroundImage = [[UIImage tallImageNamed:@"popover-background.png"] resizableImageWithCapInsets:UIEdgeInsetsMake(49, 46, 49, 45)];
