...
#define kAlertViewTitleShadowColor      [UIColor darkGrayColor]
...
#define kAlertViewMessageShadowColor    [UIColor darkGrayColor]
...
#define kAlertViewButtonShadowColor     [UIColor darkGrayColor]
#define kAlertViewButtonShadowOffset    CGSizeMake(0, -1)

#define kAlertViewBackground            @"ipad-alert.png"
#define kAlertViewBackgroundCapHeight   0
